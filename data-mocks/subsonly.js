 ...
 *
 * @example <caption>Fires an `subsonly` event, enabling slow mode on the channel.</caption>
 * subsonly
 *
 * @example <caption>Fires an `subsonly` event, disabling slow mode on the channel.</caption>
 * subsonly --off
 */
