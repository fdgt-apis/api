 ...
 *
 * @example <caption>Fires an `emoteonly` event, enabling emote-only mode on the channel.</caption>
 * emoteonly
 *
 * @example <caption>Fires an `emoteonly` event, disabling emote-only mode on the channel.</caption>
 * emoteonly --off
 */
